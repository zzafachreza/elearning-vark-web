...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.2/dist/sweetalert2.all.min.js"></script>
  ...
  <script type="text/javascript" src="<?php echo site_url() ?>assets/js/app.js"></script>
       ...
       <script src="<?php echo site_url() ?>assets/js/calendar_main.js" ></script>
         ...
         <script src="https://raw.githubusercontent.com/taalendigitaal/summernote-audio/master/summernote-audio.js"></script>
...
<body style="font-family: 'PT Sans', sans-serif;">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <li class="nav-item" <?php echo $menu=="" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?>>
       ...
       <li class="nav-item" <?php echo $menu=="kuis" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?>>
        <a class="nav-link" href="<?php echo site_url('kuis') ?>" <?php echo $menu=="kuis" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?> ><i class="flaticon-list"></i> Data Kuis</a>
      </li>
      
       <li class="nav-item" <?php echo $menu=="soal" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?>>
        <a class="nav-link" href="<?php echo site_url('soal') ?>" <?php echo $menu=="soal" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?> ><i class="flaticon-notes"></i> Data Soal</a>
      </li>
        ...
        <a class="nav-link" href="<?php echo site_url('pengguna') ?>" <?php echo $menu=="pengguna" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?> ><i class="flaticon-list"></i> Data Pengguna</a>
      </li>
...
<?php } ?>
        ...
        <a class="nav-link" href="<?php echo site_url('users') ?>" <?php echo $menu=="users" ? "style='background-color:".$comp[0]->warna_utama.";color:white;border-radius:5px'":"" ?>><i class="flaticon-user"></i> Web Admin</a>
      </li>
