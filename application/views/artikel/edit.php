    	...
    	<?php 
        			...
        			<?php echo ucfirst(str_replace("_"," ",$col->Field)) ?> 
        			  ...
        			  <?php 
        			    ...
        			    <label class="AppLabel">
        			      Keterangan
        			       ...
        			       <textarea name="<?php echo $col->Field ?>" id="summernote"><?php echo $data->{$col->Field} ?></textarea>
        			  ...
        			  <?php 
        			    ...
        			    <input autocomplete="off" value="<?php echo $data->{$col->Field} ?>" type="<?php echo $col->Field=='fid_user'?'hidden':'text' ?>" name="<?php echo $col->Field ?>" class="form-eza <?php echo $col->Field=='harga_asset'?'uang':'' ?>" id="<?php echo $col->Field ?>" autofocus="autofocus">
        			  </div>
