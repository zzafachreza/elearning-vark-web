     ...
     <div class="col col-sm-2">
      ...
      <div class="col col-sm-2">
         <a href="<?php echo site_url($modul.'/add') ?>" class="btn bg-utama col col-sm-12"><i class="flaticon-add"></i> Add</a>
	  	...
	  	<table class="table table-bordered table-striped table-hover tabza display"  style="width:100%">
	  		<thead class="bg-utama" style="color:white">
	  			<tr>
    	            <th>No</th>
    	            <th width="30%">Pertanyaan dan Diskusi</th>
    	  			<th>Nama Menu</th>
    	  			  <th>Aksi</th>
		  		...
		  		?>
		  			<tr>
		  				...
		  				<td>
		  				    ...
		  				    <?php foreach($this->db->query("SELECT * FROM data_jawab WHERE fid_catatan='".$row->id_catatan."'")->result() as $r){ ?>
		  				        <small style="margin-left:2%"><i><?php echo $r->jawaban ?></i></small> <a href="<?php echo site_url($modul.'/delete_jawaban/'.$r->id_jawab) ?>"><i class="flaticon-delete"></i></a><br/>
		  				    <?php } ?>
		  				...
		  				<td><?php echo $row->nama_lengkap ?></td>
		  				 ...
		  				 <?php if($_SESSION['level']=="Admin") { ?>
		  					<a href="<?php echo site_url($modul.'/edit/'.$row->{'id_' . $modul}) ?>" class="btn bg-kedua"><i class="flaticon-edit"></i> Jawab</a>
